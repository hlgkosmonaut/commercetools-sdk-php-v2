...
/**
 * @implements Builder<OrderStoreSetMessage>
 */
final class OrderStoreSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderStoreSetMessage
    {
        return new OrderStoreSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderStoreSetMessageBuilder
    {
        return new self();
    }
}
