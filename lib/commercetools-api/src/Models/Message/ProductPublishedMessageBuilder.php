...
/**
 * @implements Builder<ProductPublishedMessage>
 */
final class ProductPublishedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductPublishedMessage
    {
        return new ProductPublishedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPublishedMessageBuilder
    {
        return new self();
    }
}
