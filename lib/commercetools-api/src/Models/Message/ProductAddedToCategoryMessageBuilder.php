...
/**
 * @implements Builder<ProductAddedToCategoryMessage>
 */
final class ProductAddedToCategoryMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductAddedToCategoryMessage
    {
        return new ProductAddedToCategoryMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductAddedToCategoryMessageBuilder
    {
        return new self();
    }
}
