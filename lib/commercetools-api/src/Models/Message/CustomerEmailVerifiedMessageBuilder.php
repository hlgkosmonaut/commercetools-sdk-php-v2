...
/**
 * @implements Builder<CustomerEmailVerifiedMessage>
 */
final class CustomerEmailVerifiedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerEmailVerifiedMessage
    {
        return new CustomerEmailVerifiedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerEmailVerifiedMessageBuilder
    {
        return new self();
    }
}
