...
/**
 * @implements Builder<ParcelItemsUpdatedMessage>
 */
final class ParcelItemsUpdatedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ParcelItemsUpdatedMessage
    {
        return new ParcelItemsUpdatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ParcelItemsUpdatedMessageBuilder
    {
        return new self();
    }
}
