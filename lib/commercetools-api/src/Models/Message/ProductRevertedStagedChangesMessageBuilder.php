...
/**
 * @implements Builder<ProductRevertedStagedChangesMessage>
 */
final class ProductRevertedStagedChangesMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductRevertedStagedChangesMessage
    {
        return new ProductRevertedStagedChangesMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductRevertedStagedChangesMessageBuilder
    {
        return new self();
    }
}
