...
/**
 * @implements Builder<OrderReturnInfoAddedMessage>
 */
final class OrderReturnInfoAddedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderReturnInfoAddedMessage
    {
        return new OrderReturnInfoAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderReturnInfoAddedMessageBuilder
    {
        return new self();
    }
}
