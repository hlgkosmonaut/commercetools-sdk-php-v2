...
/**
 * @implements Builder<OrderCreatedMessage>
 */
final class OrderCreatedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderCreatedMessage
    {
        return new OrderCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCreatedMessageBuilder
    {
        return new self();
    }
}
