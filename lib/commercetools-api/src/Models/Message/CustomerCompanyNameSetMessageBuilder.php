...
/**
 * @implements Builder<CustomerCompanyNameSetMessage>
 */
final class CustomerCompanyNameSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerCompanyNameSetMessage
    {
        return new CustomerCompanyNameSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerCompanyNameSetMessageBuilder
    {
        return new self();
    }
}
