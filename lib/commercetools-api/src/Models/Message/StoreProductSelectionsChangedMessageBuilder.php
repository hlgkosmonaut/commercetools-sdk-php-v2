...
/**
 * @implements Builder<StoreProductSelectionsChangedMessage>
 */
final class StoreProductSelectionsChangedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): StoreProductSelectionsChangedMessage
    {
        return new StoreProductSelectionsChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreProductSelectionsChangedMessageBuilder
    {
        return new self();
    }
}
