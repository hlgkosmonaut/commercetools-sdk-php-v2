...
/**
 * @implements Builder<StoreDeletedMessage>
 */
final class StoreDeletedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): StoreDeletedMessage
    {
        return new StoreDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): StoreDeletedMessageBuilder
    {
        return new self();
    }
}
