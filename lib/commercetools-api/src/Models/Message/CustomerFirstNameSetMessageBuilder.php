...
/**
 * @implements Builder<CustomerFirstNameSetMessage>
 */
final class CustomerFirstNameSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerFirstNameSetMessage
    {
        return new CustomerFirstNameSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerFirstNameSetMessageBuilder
    {
        return new self();
    }
}
