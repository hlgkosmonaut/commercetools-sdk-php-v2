...
/**
 * @implements Builder<OrderDeletedMessage>
 */
final class OrderDeletedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderDeletedMessage
    {
        return new OrderDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderDeletedMessageBuilder
    {
        return new self();
    }
}
