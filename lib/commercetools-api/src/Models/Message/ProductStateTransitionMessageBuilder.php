...
/**
 * @implements Builder<ProductStateTransitionMessage>
 */
final class ProductStateTransitionMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductStateTransitionMessage
    {
        return new ProductStateTransitionMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductStateTransitionMessageBuilder
    {
        return new self();
    }
}
