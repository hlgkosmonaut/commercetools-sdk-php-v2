...
/**
 * @implements Builder<ProductSelectionDeletedMessage>
 */
final class ProductSelectionDeletedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductSelectionDeletedMessage
    {
        return new ProductSelectionDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductSelectionDeletedMessageBuilder
    {
        return new self();
    }
}
