...
/**
 * @implements Builder<CustomerTitleSetMessage>
 */
final class CustomerTitleSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerTitleSetMessage
    {
        return new CustomerTitleSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerTitleSetMessageBuilder
    {
        return new self();
    }
}
