...
/**
 * @implements Builder<DeliveryRemovedMessage>
 */
final class DeliveryRemovedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): DeliveryRemovedMessage
    {
        return new DeliveryRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DeliveryRemovedMessageBuilder
    {
        return new self();
    }
}
