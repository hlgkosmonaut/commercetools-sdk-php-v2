...
/**
 * @implements Builder<ProductSelectionCreatedMessage>
 */
final class ProductSelectionCreatedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductSelectionCreatedMessage
    {
        return new ProductSelectionCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductSelectionCreatedMessageBuilder
    {
        return new self();
    }
}
