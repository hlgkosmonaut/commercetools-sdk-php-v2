...
/**
 * @implements Builder<OrderShipmentStateChangedMessage>
 */
final class OrderShipmentStateChangedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderShipmentStateChangedMessage
    {
        return new OrderShipmentStateChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderShipmentStateChangedMessageBuilder
    {
        return new self();
    }
}
