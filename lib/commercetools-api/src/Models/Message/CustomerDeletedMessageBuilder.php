...
/**
 * @implements Builder<CustomerDeletedMessage>
 */
final class CustomerDeletedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerDeletedMessage
    {
        return new CustomerDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerDeletedMessageBuilder
    {
        return new self();
    }
}
