...
/**
 * @implements Builder<OrderCustomerEmailSetMessage>
 */
final class OrderCustomerEmailSetMessageBuilder implements Builder
{
    ...
    public function build(): OrderCustomerEmailSetMessage
    {
        return new OrderCustomerEmailSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCustomerEmailSetMessageBuilder
    {
        return new self();
    }
}
