...
/**
 * @implements Builder<OrderCustomerGroupSetMessage>
 */
final class OrderCustomerGroupSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderCustomerGroupSetMessage
    {
        return new OrderCustomerGroupSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderCustomerGroupSetMessageBuilder
    {
        return new self();
    }
}
