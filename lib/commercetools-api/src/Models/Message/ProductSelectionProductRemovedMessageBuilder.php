...
/**
 * @implements Builder<ProductSelectionProductRemovedMessage>
 */
final class ProductSelectionProductRemovedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductSelectionProductRemovedMessage
    {
        return new ProductSelectionProductRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductSelectionProductRemovedMessageBuilder
    {
        return new self();
    }
}
