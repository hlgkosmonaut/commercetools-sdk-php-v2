...
/**
 * @implements Builder<ProductPriceDiscountsSetMessage>
 */
final class ProductPriceDiscountsSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductPriceDiscountsSetMessage
    {
        return new ProductPriceDiscountsSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductPriceDiscountsSetMessageBuilder
    {
        return new self();
    }
}
