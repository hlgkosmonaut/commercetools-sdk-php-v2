...
/**
 * @implements Builder<OrderShippingAddressSetMessage>
 */
final class OrderShippingAddressSetMessageBuilder implements Builder
{
    ...
    public function build(): OrderShippingAddressSetMessage
    {
        return new OrderShippingAddressSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderShippingAddressSetMessageBuilder
    {
        return new self();
    }
}
