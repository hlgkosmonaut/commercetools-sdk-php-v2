...
/**
 * @implements Builder<CustomerEmailChangedMessage>
 */
final class CustomerEmailChangedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerEmailChangedMessage
    {
        return new CustomerEmailChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerEmailChangedMessageBuilder
    {
        return new self();
    }
}
