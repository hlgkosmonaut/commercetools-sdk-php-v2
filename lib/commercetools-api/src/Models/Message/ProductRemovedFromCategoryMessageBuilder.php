...
/**
 * @implements Builder<ProductRemovedFromCategoryMessage>
 */
final class ProductRemovedFromCategoryMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductRemovedFromCategoryMessage
    {
        return new ProductRemovedFromCategoryMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductRemovedFromCategoryMessageBuilder
    {
        return new self();
    }
}
