...
/**
 * @implements Builder<OrderDiscountCodeStateSetMessage>
 */
final class OrderDiscountCodeStateSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderDiscountCodeStateSetMessage
    {
        return new OrderDiscountCodeStateSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderDiscountCodeStateSetMessageBuilder
    {
        return new self();
    }
}
