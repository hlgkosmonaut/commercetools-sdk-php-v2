...
/**
 * @implements Builder<OrderMessage>
 */
final class OrderMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderMessage
    {
    ...
    public static function of(): OrderMessageBuilder
    {
        return new self();
    }
}
