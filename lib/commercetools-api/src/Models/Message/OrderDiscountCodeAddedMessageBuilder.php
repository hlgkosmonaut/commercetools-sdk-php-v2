...
/**
 * @implements Builder<OrderDiscountCodeAddedMessage>
 */
final class OrderDiscountCodeAddedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderDiscountCodeAddedMessage
    {
        return new OrderDiscountCodeAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderDiscountCodeAddedMessageBuilder
    {
        return new self();
    }
}
