 ...
 */
final class OrderLineItemDistributionChannelSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderLineItemDistributionChannelSetMessage
    {
        return new OrderLineItemDistributionChannelSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderLineItemDistributionChannelSetMessageBuilder
    {
        return new self();
    }
}
