...
/**
 * @implements Builder<CustomerDateOfBirthSetMessage>
 */
final class CustomerDateOfBirthSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerDateOfBirthSetMessage
    {
        return new CustomerDateOfBirthSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerDateOfBirthSetMessageBuilder
    {
        return new self();
    }
}
