...
/**
 * @implements Builder<OrderPaymentStateChangedMessage>
 */
final class OrderPaymentStateChangedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderPaymentStateChangedMessage
    {
        return new OrderPaymentStateChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderPaymentStateChangedMessageBuilder
    {
        return new self();
    }
}
