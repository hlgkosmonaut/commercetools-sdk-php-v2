...
/**
 * @implements Builder<CategorySlugChangedMessage>
 */
final class CategorySlugChangedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public static function of(): CategorySlugChangedMessageBuilder
    {
        return new self();
    }
}
