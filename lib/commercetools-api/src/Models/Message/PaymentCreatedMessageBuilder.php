...
/**
 * @implements Builder<PaymentCreatedMessage>
 */
final class PaymentCreatedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): PaymentCreatedMessage
    {
    ...
    public static function of(): PaymentCreatedMessageBuilder
    {
        return new self();
    }
}
