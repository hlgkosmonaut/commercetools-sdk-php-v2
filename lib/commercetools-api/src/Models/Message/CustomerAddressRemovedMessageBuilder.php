...
/**
 * @implements Builder<CustomerAddressRemovedMessage>
 */
final class CustomerAddressRemovedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerAddressRemovedMessage
    {
        return new CustomerAddressRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerAddressRemovedMessageBuilder
    {
        return new self();
    }
}
