...
/**
 * @implements Builder<CustomerAddressChangedMessage>
 */
final class CustomerAddressChangedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerAddressChangedMessage
    {
        return new CustomerAddressChangedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerAddressChangedMessageBuilder
    {
        return new self();
    }
}
