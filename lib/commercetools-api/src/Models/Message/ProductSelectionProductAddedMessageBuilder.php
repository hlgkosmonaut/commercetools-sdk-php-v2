...
/**
 * @implements Builder<ProductSelectionProductAddedMessage>
 */
final class ProductSelectionProductAddedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public static function of(): ProductSelectionProductAddedMessageBuilder
    {
        return new self();
    }
}
