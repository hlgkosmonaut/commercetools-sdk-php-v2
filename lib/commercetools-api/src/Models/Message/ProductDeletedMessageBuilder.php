...
/**
 * @implements Builder<ProductDeletedMessage>
 */
final class ProductDeletedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductDeletedMessage
    {
        return new ProductDeletedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductDeletedMessageBuilder
    {
        return new self();
    }
}
