...
/**
 * @implements Builder<CustomerPasswordUpdatedMessage>
 */
final class CustomerPasswordUpdatedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerPasswordUpdatedMessage
    {
        return new CustomerPasswordUpdatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerPasswordUpdatedMessageBuilder
    {
        return new self();
    }
}
