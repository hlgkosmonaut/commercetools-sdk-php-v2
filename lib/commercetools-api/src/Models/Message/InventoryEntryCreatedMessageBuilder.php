...
/**
 * @implements Builder<InventoryEntryCreatedMessage>
 */
final class InventoryEntryCreatedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): InventoryEntryCreatedMessage
    {
        return new InventoryEntryCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): InventoryEntryCreatedMessageBuilder
    {
        return new self();
    }
}
