...
/**
 * @implements Builder<ParcelTrackingDataUpdatedMessage>
 */
final class ParcelTrackingDataUpdatedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ParcelTrackingDataUpdatedMessage
    {
        return new ParcelTrackingDataUpdatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ParcelTrackingDataUpdatedMessageBuilder
    {
        return new self();
    }
}
