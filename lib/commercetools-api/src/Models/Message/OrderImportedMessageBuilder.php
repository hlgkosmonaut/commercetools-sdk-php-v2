...
/**
 * @implements Builder<OrderImportedMessage>
 */
final class OrderImportedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderImportedMessage
    {
        return new OrderImportedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderImportedMessageBuilder
    {
        return new self();
    }
}
