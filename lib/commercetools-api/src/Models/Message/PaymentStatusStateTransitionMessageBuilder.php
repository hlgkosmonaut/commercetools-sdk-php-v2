...
/**
 * @implements Builder<PaymentStatusStateTransitionMessage>
 */
final class PaymentStatusStateTransitionMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): PaymentStatusStateTransitionMessage
    {
        return new PaymentStatusStateTransitionMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): PaymentStatusStateTransitionMessageBuilder
    {
        return new self();
    }
}
