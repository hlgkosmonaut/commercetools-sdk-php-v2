...
/**
 * @implements Builder<OrderDiscountCodeRemovedMessage>
 */
final class OrderDiscountCodeRemovedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): OrderDiscountCodeRemovedMessage
    {
        return new OrderDiscountCodeRemovedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): OrderDiscountCodeRemovedMessageBuilder
    {
        return new self();
    }
}
