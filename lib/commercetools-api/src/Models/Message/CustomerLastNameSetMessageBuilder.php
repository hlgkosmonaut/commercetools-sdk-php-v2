...
/**
 * @implements Builder<CustomerLastNameSetMessage>
 */
final class CustomerLastNameSetMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): CustomerLastNameSetMessage
    {
        return new CustomerLastNameSetMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): CustomerLastNameSetMessageBuilder
    {
        return new self();
    }
}
