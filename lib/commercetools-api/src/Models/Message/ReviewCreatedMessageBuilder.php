 ...
 */
final class ReviewCreatedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ReviewCreatedMessage
    {
        return new ReviewCreatedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ReviewCreatedMessageBuilder
    {
        return new self();
    }
}
