...
/**
 * @implements Builder<ProductUnpublishedMessage>
 */
final class ProductUnpublishedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): ProductUnpublishedMessage
    {
        return new ProductUnpublishedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): ProductUnpublishedMessageBuilder
    {
        return new self();
    }
}
