...
/**
 * @implements Builder<DeliveryAddedMessage>
 */
final class DeliveryAddedMessageBuilder implements Builder
{
    /**
     * @var ?string
     */
    ...
    public function build(): DeliveryAddedMessage
    {
        return new DeliveryAddedMessageModel(
            $this->id,
            $this->version,
            $this->createdAt,
            $this->lastModifiedAt,
    ...
    public static function of(): DeliveryAddedMessageBuilder
    {
        return new self();
    }
}
