...
final class TypedMoneyModel extends JsonObjectModel implements TypedMoney
{
    ...
    /**
     * <p>The commercetools Platform supports two different types of Money, one for amounts in cent precision and another one for sub-cent amounts up to 12 fraction digits.</p>
     *
     * @return null|string
     */
